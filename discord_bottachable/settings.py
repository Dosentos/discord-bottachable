"""
Django settings for discord_bottachable project on Heroku. For more info, see:
...
LOGGING = {
    ...
    'loggers': {
        ...
        'django': {
            'handlers': ['development_logfile', 'console', 'sentry'],
            'propagate': False,
        },
        'py.warnings': {
            'handlers': ['development_logfile', 'console', 'sentry'],
...
# Sentry settings (RAVEN CONFIG IN THE BOTTOM OF THE FILE)
...
ROOT_URLCONF = 'discord_bottachable.urls'
...
WSGI_APPLICATION = 'discord_bottachable.wsgi.application'
